...
struct AppEnvironment {
    ...
    static func fromStorage(defaults: UserDefaults = .standard) -> Environment {
        ...
        if let data = defaults.object(forKey: Constants.UserDefaults.excludeApplications) as? Data, let applications = try? NSKeyedUnarchiver.unarchiveTopLevelObjectWithData(data) as? [CPYAppInfo] {
