...
final class CPYUtilities {
    ...
    static func registerUserDefaultKeys() {
        ...
        defaultValues.updateValue(NSNumber(value: 1000), forKey: Constants.UserDefaults.maxHistorySize)
        ...
        defaultValues.updateValue(NSNumber(value: true), forKey: Constants.UserDefaults.showSearchBarInTheMenu)

        /* Menu */
        defaultValues.updateValue(NSNumber(value: 16), forKey: Constants.UserDefaults.menuIconSize)
        defaultValues.updateValue(NSNumber(value: 30), forKey: Constants.UserDefaults.maxMenuItemTitleLength)
        defaultValues.updateValue(NSNumber(value: 20), forKey: Constants.UserDefaults.numberOfItemsPlaceInline)
        defaultValues.updateValue(NSNumber(value: 30), forKey: Constants.UserDefaults.numberOfItemsPlaceInsideFolder)
